...
game_unlock = Game.create(
    title: "Unlock: The Island of Cr Goorse", 
    min_players: 1, 
    max_players: 6, 
...
game_quiddler = Game.create(
    ...
    category: "language", 
    play_style: "competitive")
game_tenzi = Game.create(
    title: "Tenzi", 
    min_players: 2, 
    max_players: 6, 
    description: "Roll them quick and roll them fast! Not five, not seven, but TEN dice in your hand. Someone shouts 'Go!' and the game is off with unprecedented speed. Rolling all of the same number is your aim, and you have as many chances as you need to do it. The first cast reveals three 5's, you pick up the remaining seven dice and shake out two more 5's. Victory is close... it's in your hand.", 
    game_type: "dice", 
    category: "chance", 
    play_style: "competitive")
...
game_dracula = Game.create(
    ...
    category: "horror", 
    play_style: "competitive")
game_uno = Game.create(
    title: "Uno", 
    min_players: 2, 
    max_players: 10, 
    description: "layers take turns racing to get rid of all their cards by matching a card in their hand with the current card shown on top of the deck either by color or number.", 
    game_type: "card", 
    category: "chance", 
    play_style: "competitive")
